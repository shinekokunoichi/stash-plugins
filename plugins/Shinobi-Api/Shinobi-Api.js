 ...
 */
ShinobiApi.prototype.observe = function (selector, callback) {
 ...
 * @param {function} callback Function to run with selected element as parameter
 */
ShinobiApi.prototype.wait = function (selector, callback) {
    PluginApi.Event.addEventListener('stash:location', this.observe(selector, callback));
};
...
/**
 * Get or set style
 * @param {string} option JS style name
...
skTask.prototype.makeContainer = function () {
    ...
    const settingSection = new sk.ui.container();
    settingSection.class('setting-section', true);
    const title = new sk.ui.title('Plugin Tasks');
